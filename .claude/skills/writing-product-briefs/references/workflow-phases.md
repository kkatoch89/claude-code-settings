...
Present your understanding, then confirm:
...
Present thesis and antithesis, then confirm:
...
Present audience and metrics, then confirm:
...
Present scenarios, then confirm:
...
- Options:
  ...
  - "Create PRD" -- Use `writing-prds` to transform into requirements
  - "Done" -- End workflow
