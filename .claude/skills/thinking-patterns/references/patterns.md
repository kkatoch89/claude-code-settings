...
Complete definitions for all thinking patterns including mechanisms, processes, examples, and anti-patterns.

## Table of Contents

1. [Chain of Thought (CoT)](#chain-of-thought-cot)
2. [Atomic Thought (AoT)](#atomic-thought-aot)
3. [Tree of Thoughts (ToT)](#tree-of-thoughts-tot)
4. [Skeleton of Thought (SoT)](#skeleton-of-thought-sot)
5. [Program of Thoughts (PoT)](#program-of-thoughts-pot)
6. [Self-Consistency](#self-consistency)
7. [Graph of Thoughts (GoT)](#graph-of-thoughts-got)
...
- **Separation of concerns**: Reasoning is not calculation
