...
| Situation | Pattern | Application |
|-----------|---------|-------------|
| Identifying slice boundaries | `atomic-thought` | Decompose feature into independent aspects |
| Ordering slices | `tree-of-thoughts` | Evaluate multiple orderings for risk/value |
| Verifying slice validity | `self-consistency` | Check each slice against validity rules |

## Task Decomposition Phase

| Situation | Pattern | Application |
|-----------|---------|-------------|
| Complex multi-system story | `atomic-thought` | Decompose requirements into independent parts |
| Verifying task completeness | `self-consistency` | Evaluate from multiple perspectives |
| Identifying hidden work | `chain-of-thought` | Walk through story end-to-end |
...
- Feature slicing has ambiguous boundaries
- Task decomposition reveals gaps
