...
For editing mechanics (passive voice conversion, sentence splitting, nominalization reversal), see [conciseness-techniques.md](conciseness-techniques.md).
...
1. **Vocabulary:** Do banned words appear? Count matches -- target zero.
...
For full validation metrics (reading level, passive voice %, sentence length), see the validation checklist in [writing-for-humans.md](writing-for-humans.md) and the readability metrics in [conciseness-techniques.md](conciseness-techniques.md).
