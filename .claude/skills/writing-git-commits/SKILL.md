...
description: Writes clear, professional Git commit messages following Tim Pope's style guide. Use when committing staged changes, crafting commit messages, or when the user invokes /commit.
---
...
- "If applied, this commit will **Fixed the bug**" - incorrect
- "If applied, this commit will **Refactor payment module for clarity**" - correct
...
- [Branch Workflow](references/branch-workflow.md)
